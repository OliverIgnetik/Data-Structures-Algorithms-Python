...
are added to the PQ. Whenever the PQ is polled the edge with the lowest cost is selected.
...
NamedTuple is appropriate if we don't want the edge data to change and we don't need to change
the __lt__ dunder methods
